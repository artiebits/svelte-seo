...
test.describe("Testing OpenGraph meta tags", async()=>{
    ...
    test("Loads og:image:url tag correctly", async ( { page })=>{
        ...
        expect(element,"The tag must exist").toBeDefined();
        expect(await element.count(),"Loads the right amount of tags").toBe(data.openGraph?.images?.length);
    });
    ...
    test("Loads og:locale:alternate tag correctly", async ( { page })=>{
        ...
        expect(element,"The tag must exist").toBeDefined();
        expect(await element.count(),"Loads the right amount of tags").toBe(data.openGraph?.localeAlternate?.length);
    });
    ...
    test("Loads og:video tag correctly", async ( { page })=>{
        ...
        expect(element,"The tag must exist").toBeDefined();
        expect(await element.count(),"Loads the right amount of tags").toBe(data.openGraph?.videos?.length);
    });
    ...
    test("Loads music:album:disc tag correctly", async ( { page })=>{
        ...
        expect(element,"The tag must exist").toBeDefined();
        expect(await element.getAttribute("content")).toBe(data.openGraph?.music?.albumDisc?.toString());
    });

    test("Loads music:album:track tag correctly", async ( { page })=>{
        const element = page.locator("meta[property='music:album:track']");
        expect(element,"The tag must exist").toBeDefined();
        expect(await element.getAttribute("content")).toBe(data.openGraph?.music?.albumTrack?.toString());
    });
